...
class Api::V1::SubscribersDashboardController < ActionController::API
    ...
    def subscriber_params
        params.require(:subscribers_dashboard).require(:subscriber).permit(:firstname, :lastname, :email, :phone, :facebook_id, :broker_status, :broker_comment, :hot_lead, :broker_meeting, :is_active, :has_stopped, :has_stopped_at)
    end  
