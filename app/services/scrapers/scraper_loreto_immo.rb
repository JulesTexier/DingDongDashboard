class ScraperLoretoImmo < Scraper
      ...
      fetch_main_page(self).each do |item|
        begin
          ...
          if go_to_prop?(hashed_property, 7)
            ...
            hashed_property[:images] = access_xml_link(item, "img.autoScale", "src")
            hashed_property[:images].collect! { |img| "https://www.loretoimmobilier.com" + img } # Don't suceed to load images in show pages
