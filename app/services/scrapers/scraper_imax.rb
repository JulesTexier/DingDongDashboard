  ...
  def extract_first_page
    ...
    xml.each do |item|
      begin
        ...
        hashed_property[:rooms_number] = regex_gen(access_xml_text(item, "div.margin-bottom-10.padding-bottom-10.border-solid-bottom-block-1.pagination-centered > p"), '(\d+)(.?)(\r\n)(pi(è|e)ce(s?))').to_float_to_int_scrp
        hashed_property[:price] = regex_gen(access_xml_text(item, "div.prix-annonce"), '(\d)(.*)(\r\n)( *)(€)').to_int_scrp
