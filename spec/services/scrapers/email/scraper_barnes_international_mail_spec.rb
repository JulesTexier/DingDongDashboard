...
RSpec.describe Email::ScraperBarnesInternationalMail, type: :service do
  before(:all) do
    @s = Email::ScraperBarnesInternationalMail.new('<html><a href="https://ap.immo/p/3989221?u=11572402&p=56de2c526c3c4aeda0400dce64d7fe507ef048f3"></html>')
  end
