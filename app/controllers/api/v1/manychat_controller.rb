...
class Api::V1::ManychatController < ApplicationController
  ...
  def subscriber_params
    params.permit(:firstname, :lastname, :email, :phone, :is_active, :subscriber_id, :message, :facebook_id, :status, :is_blocked, :messenger_flux, :email_flux, :broker_id, :notary_id, :contractor_id, :hot_lead)
  end
