class ScraperImmobilierParisien < Scraper
      ...
      fetch_main_page(self).each do |item|
        begin
          ...
          if go_to_prop?(hashed_property, 7)
            ...
            hashed_property[:description] = access_xml_text(html, "div.content > p").strip
            ...
            hashed_property[:agency_name] = "Immobilier Parisien"
