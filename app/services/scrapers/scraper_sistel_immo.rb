class ScraperSistelImmo < Scraper
  attr_accessor :url, :properties, :source, :main_page_cls, :type, :waiting_cls, :multi_page, :page_nbr

  def initialize
    @url = "http://www.sistel-immo.fr/immobilier/pays/achat/france.htm#ci=750056&idpays=250&idqfix=1&idtt=2&lang=fr&pres=basic&surf_terrainmax=Max&surf_terrainmin=Min&surfacemax=Max&surfacemin=Min&tri=d_dt_crea"
    @source = "Sistel Immo"
