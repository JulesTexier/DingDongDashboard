class RegularSites::ScraperFigaro < Scraper
      ...
      begin
        ...
        if go_to_prop?(hashed_property, 7)
          ...
          if hashed_property[:link].include?("https://proprietes.lefigaro.fr")
            ...
            hashed_property[:flat_type] = regex_gen(access_xml_text(html, "div.main-title-annonce > h1 > span"), "((a|A)ppartement|(A|a)ppartements|(S|s)tudio|(S|s)tudette|(C|c)hambre|(M|m)aison)")
            ...
            hashed_property[:flat_type] = regex_gen(access_xml_text(html, "div.container-h1 > h1"), "((a|A)ppartement|(A|a)ppartements|(S|s)tudio|(S|s)tudette|(C|c)hambre|(M|m)aison)")
