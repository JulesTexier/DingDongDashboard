      ...
      fetch_main_page(self).each do |item|
        begin
          ...
          if go_to_prop?(hashed_property, 7)     
            ...
            hashed_property[:bedroom_number] = access_xml_text(html, "li.spaces-item:nth-child(2) > span:nth-child(2)").to_int_scrp
           hashed_property[:description] = access_xml_text(html, ".description-content").strip
            ...
            hashed_property[:contact_number] = access_xml_text(html, '.agencyTeaser-phone').gsub(" ","")
