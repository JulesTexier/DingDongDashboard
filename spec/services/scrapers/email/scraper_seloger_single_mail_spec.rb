...
RSpec.describe Email::ScraperSeLogerSingle, type: :service do
  before(:all) do
    @s = Email::ScraperSeLogerSingle.new(YAML.load_file("fixtures/vcr_cassettes/seloger_single_mail.yml"))
  end
